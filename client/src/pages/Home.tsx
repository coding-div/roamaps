...
export default function Home() {
  ...
  async function readCfdJaalFile(file: File) {
    ...
    if (!file.name.toLocaleLowerCase().endsWith(CFD_JAAL_EXTENSION)) {
      toast.error("Choose a CFD Jaal (.cfdj) file.");
      return;
    }
    try {
      ...
      toast.error(error instanceof CfdJaalValidationError ? error.message : "This file could not be checked safely.");
    }
  }
